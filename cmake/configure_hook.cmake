# Run tools/configure.py, so `cmake --preset debug` is the only command you ever
# need after editing raylib.toml.
#
...
# WIN32/APPLE/UNIX/MSVC and the compiler variables do not exist yet. In
# particular find_package(Python3) must not be used here — it branches on
# exactly those. find_program runs before all of it.
#
...
set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS
  "${CMAKE_CURRENT_SOURCE_DIR}/raylib.toml")
...
elseif(EXISTS "${_tpl_generated}")
  message(WARNING
    ...
    "configuration in cmake/generated/. Edits to raylib.toml will NOT be "
    "picked up.")
else()
  message(FATAL_ERROR
    "no usable Python 3.11+ found and nothing has been generated yet.\n"
    "raylib.toml has to be turned into build files before this project can "
    "configure.\n"
